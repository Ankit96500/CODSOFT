...
entry.grid(row=0,column=0,columnspan=50,ipady=20,pady=20)
...
button_clear=tk.Button(master=frame,text="clear",padx=15,pady=5,width=18,command=clear)
button_clear.grid(row=6,column=1,columnspan=2,pady=2)

button_equal=tk.Button(master=frame,text="=",padx=15,pady=5,width=30,command=equal)
